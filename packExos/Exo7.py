...
while refaire != 1:
    ...
    if br < (CONST / 2):
        ...
        print(f"Temps chrono tardive: {tempschrono}")
    if ((CONST / 2) < br) and (br < ((CONST / 2) + 2)):
    ...
    if (choix == 0) :
        refaire = 1
print(f"\t+++++++++RESULTAT TOTAL DES TESTS: ")
print(f"\t BONNES REPONSES TOTALES: {br}")
print(f"\t MAUVAISES REPONSES TOTATLES: {mr}")
print(f"Temps chrono total tardive: {tempschrono}")
